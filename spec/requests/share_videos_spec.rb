...
RSpec.describe 'ShareVideos', type: :request do
  ...
  describe 'GET /index' do
    it 'renders a successful response' do
      ShareVideo.create! valid_attributes.merge(user:)
  ...
  describe 'GET /show' do
    it 'renders a successful response' do
      share_video = ShareVideo.create! valid_attributes.merge(user:)
  ...
  describe 'POST /create' do
    context 'with valid parameters' do
      it 'creates a new ShareVideo and redirects' do
        ...
        end.to change(ShareVideo, :count).by(1)
    ...
    context 'with invalid parameters' do
      it 'does not create a new ShareVideo' do
        ...
        end.to change(ShareVideo, :count).by(0)
